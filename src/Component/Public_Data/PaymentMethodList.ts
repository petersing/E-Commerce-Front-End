...
const PaymentMethodListsForPunchase =()=>{
    return(
        {CreditCard: "Credit Card"}
    )
}

const DeliveryMethodListsForPunchase =()=>{
    return(
        {Free: "Free Shipping", 
         Express: "Express Shipping", 
         Speed: "Speed Shipping"}
    )
}
...
export {DeliveryMethodLists, PaymentMethodLists, SubscribeMethodLists, SubscribeMethodDurationLists, DeliveryMethodListsForPunchase, PaymentMethodListsForPunchase}