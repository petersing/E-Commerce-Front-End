...
import { DeliveryMethodLists, DeliveryMethodListsForPunchase, PaymentMethodLists, PaymentMethodListsForPunchase } from "../../Public_Data/PaymentMethodList";

const ModifyCartFunction = gql`
mutation ModifyCartFunction($Clear: Boolean!) {
    ModifyCartFunction(Clear: $Clear) {
        ResponseCart
    }
}
`
...
const ConfirmAndPay = (props:{setActiveStep: Function, DeliveryMethod: string, Client_Information: {Name: string, Email: string, Phone: string, Address: string}
    ...
    const DeliveryMethodListForPunchase : {[name: string] : string} = DeliveryMethodListsForPunchase()
    const PaymentMethodListForPunchase : {[name: string] : string} = PaymentMethodListsForPunchase()
    ...
    function CreatePayment(){
        ...
        Order_API.CreateOrder({access: cookies['access'], 
                               ...
                               PaymentMethod: PaymentMethodListForPunchase[props.PaymentMethod], 
                               DeliveryMethod: DeliveryMethodListForPunchase[props.DeliveryMethod]}}).then((res)=>{
          ModifyFunction({variables: {Clear: props.Clear}})
