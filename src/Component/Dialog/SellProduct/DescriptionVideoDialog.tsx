...
const DescriptionVideoDialog = (props: {open: boolean, onclose: Function, VideoList: string[], forceUpdate: Function, setVideoList: Dispatch<SetStateAction<string[]>>}) => { 
    ...
    function ParseVideo(VideoURL: string){
        ...
        props.setVideoList((VideoList) => [...VideoList, VideoCode])
    }

    function DeleteVideo(loc: number){
        props.setVideoList(props.VideoList.filter((video, code) => code !== loc))
    }
