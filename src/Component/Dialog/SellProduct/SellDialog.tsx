...
import { Dialog, DialogContent, DialogTitle,Button, Grid, Alert} from '@mui/material';
...
const SellDialog = (props: {Open: boolean, setOpenFunction: React.Dispatch<React.SetStateAction<boolean>>, Product?: Management_Product_Object, UserData: User_Object}) => {
  ...
  const [AlertInformation, setAlertInformation] = useState<string|null>()
      ...
      <Dialog open={props.Open} onClose={() => props.setOpenFunction(false)} fullWidth maxWidth={'md'} sx={{minWidth: '1200px'}}>
        ...
        <DialogContent>
          ...
          <Grid container columns={12}>
            ...
            <ProductInformation setSuccessResponse={setSuccessResponse} SuccessResponse={SuccessResponse} ImageList={ImageList} ItemRender={ItemRender} setAlertInformation={setAlertInformation}/>       
